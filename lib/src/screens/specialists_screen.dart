          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  Text('Upcoming Appointment', style: GoogleFonts.lato(fontSize: 18, fontWeight: FontWeight.w500, color: Color.fromRGBO(0, 99, 99, 30)),),
            ...
            Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  Text("Let's find your specialist", style: GoogleFonts.lato(fontSize: 18, fontWeight: FontWeight.w500, color: Color.fromRGBO(0, 99, 99, 30)),),
                  Text('See more', style: GoogleFonts.lato(color: Color.fromRGBO(30, 193, 194, 30)))
                ],
              ),
            ),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Text('All Major', style: GoogleFonts.lato(color: Colors.white))
                      ],
                    ),
                  ),
