      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Ho Quang Bao', style: GoogleFonts.lato(fontSize: 25, fontWeight: FontWeight.w700),),
            ...
            Container(
              ...
              child: ListTile(
                ...
                title: Text('Notification', style: GoogleFonts.lato(),),
                trailing: Icon(Icons.arrow_forward_ios_outlined),
              ),
            ),
            SizedBox(height: SizeConfig.blockSizeVertical * 2,),
            Container(
              ...
              child: ListTile(
                ...
                title: Text('Wallet', style: GoogleFonts.lato(),),
                trailing: Icon(Icons.arrow_forward_ios_outlined),
              ),
            ),
            SizedBox(height: SizeConfig.blockSizeVertical * 2,),
