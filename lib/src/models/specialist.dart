...
class Specialist {
    ...
    factory Specialist.fromJson(Map<String, dynamic> json) => Specialist(
        ...
        listSpec: List<ListSpec>.from(json["listSpec"].map((x) => ListSpec.fromJson(x))),
    );
...
SpecialistDetails specialistDetailsFromJson(String str) => SpecialistDetails.fromJson(json.decode(str));

String specialistDetailsToJson(SpecialistDetails data) => json.encode(data.toJson());
...
class SpecialistDetails {
    ...
    factory SpecialistDetails.fromJson(Map<String, dynamic> json) => SpecialistDetails(
